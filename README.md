...
**本项目暂时处于archive状态，感觉没有太多合规的通用操作可以改进，深挖后端漏洞耗费精力性价比很低，大家有个性化的mod可以进行 Pull Request 分享。需要 PR 的小伙伴记得往mod中补充功能，直接往main提交即可，不用创建新分支，提交格式为`署名-功能名-版本号.js`，任何包含其他修改的PR均不会被接受。我会定期处理PR，爱你❤**
